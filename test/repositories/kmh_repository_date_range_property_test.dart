...
void main() {
  group('KMH Repository Date Range Filtering Property Tests', () {
    ...
    PropertyTest.forAll<Map<String, dynamic>>(
      description:
          'Property 18: Date range filtering - only transactions within range returned',
      generator: () {
      ...
      property: (data) async {
        ...
        for (var tx in retrieved) {
          final originalTx = transactionsData.firstWhere(
            (t) => t['id'] == tx.id,
          );
          expect(
            originalTx['inRange'],
    ...
    PropertyTest.forAll<Map<String, dynamic>>(
      description:
          'Property 18: Date range filtering - total interest calculated correctly',
      generator: () {
        final walletId = const Uuid().v4();
        ...
        final transactions = List.generate(transactionCount, (index) {
          ...
          return {
            ...
            'interestAmount': type == KmhTransactionType.interest
                ? amount
                : null,
            'inRange': inRange,
          };
      ...
      property: (data) async {
        ...
        final expectedTotalInterest = transactionsData
            .where((tx) {
              final date = tx['date'] as DateTime;
              final inRange =
                  date.isAfter(
        ...
        expect(
          ...
          lessThan(0.01),
          reason:
              'Total interest $actualTotalInterest should equal expected $expectedTotalInterest',
        );
    ...
    PropertyTest.forAll<Map<String, dynamic>>(
      description:
          'Property 18: Date range filtering - boundary dates included correctly',
      generator: () {
        final walletId = const Uuid().v4();
      ...
      property: (data) async {
        ...
        final expectedCount = transactionsData
            .where((tx) => tx['shouldBeIncluded'] == true)
            .length;
        ...
        for (var txData in transactionsData) {
          if (txData['shouldBeIncluded'] == true) {
            ...
            expect(
              ...
              isTrue,
              reason:
                  'Transaction ${txData['id']} (${txData['description']}) should be included',
            );
          }
        }
        ...
        for (var txData in transactionsData) {
          if (txData['shouldBeIncluded'] == false) {
            ...
            expect(
              ...
              isFalse,
              reason:
                  'Transaction ${txData['id']} (${txData['description']}) should be excluded',
            );
          }
        }
    ...
    PropertyTest.forAll<Map<String, dynamic>>(
      description:
          'Property 18: Date range filtering - empty range returns no transactions',
      generator: () {
        final walletId = const Uuid().v4();
      ...
      property: (data) async {
        ...
        final totalInterest = await repository.getTotalInterest(
          walletId,
          startDate,
          endDate,
        );
    ...
    PropertyTest.forAll<Map<String, dynamic>>(
      description:
          'Property 18: Date range filtering - total withdrawals and deposits calculated correctly',
      generator: () {
        final walletId = const Uuid().v4();
      ...
      property: (data) async {
        ...
        expect(
          ...
          lessThan(0.01),
          reason:
              'Total withdrawals $actualWithdrawals should equal expected $expectedWithdrawals',
        );
        ...
        expect(
          ...
          lessThan(0.01),
          reason:
              'Total deposits $actualDeposits should equal expected $expectedDeposits',
        );
    ...
    PropertyTest.forAll<Map<String, dynamic>>(
      description:
          'Property 18: Date range filtering - single day range works correctly',
      generator: () {
        final walletId = const Uuid().v4();
      ...
      property: (data) async {
        ...
        for (var tx in retrieved) {
          expect(
            ...
            isTrue,
            reason:
                'Transaction date ${tx.date} should be on target date $targetDate',
          );
        }
