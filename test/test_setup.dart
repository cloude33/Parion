...
class TestSetup {
    ...
    TestDefaultBinaryMessengerBinding.instance.defaultBinaryMessenger
        .setMockMethodCallHandler(
          ...
          (MethodCall methodCall) async {
            switch (methodCall.method) {
              case 'check':
                return ['wifi']; // Return list of connectivity results
              case 'wifiName':
                return 'TestWiFi';
              case 'wifiBSSID':
  ...
  static Future<void> setupTest() async {
    ...
    // Setup dependency injection for auth services
    try {
      ...
      if (e.toString().contains('MissingPluginException') || 
        ...
        print('Warning: Some platform dependencies not available: $e');
      } else {
        rethrow;
      }
    }
  ...
  static Future<void> tearDownTest() async {
    try {
      ...
      try {
        ...
        print('Dependency cleanup warning: $e');
      }
    } catch (e) {
      // Ignore cleanup errors
