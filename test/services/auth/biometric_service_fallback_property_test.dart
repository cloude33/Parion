    ...
    PropertyTest.forAll<Map<String, dynamic>>(
      ...
      generator: () {
        ...
        final failureTypes = [
          ...
          {'type': 'not_available', 'errorCode': 'NotAvailable'},
          {'type': 'not_enrolled', 'errorCode': 'NotEnrolled'},
          {'type': 'locked_out', 'errorCode': 'LockedOut'},
          {
          ...
          },
          {
            ...
            'errorCode': 'BiometricOnlyNotSupported',
          },
