...
void main() {
  group('KMH Balance Classification Property Tests', () {
    ...
    PropertyTest.forAll<Map<String, dynamic>>(
      description:
          'Property 24: KMH accounts with positive balance are classified as assets',
      generator: () {
      ...
      property: (data) async {
        ...
        expect(
          positiveAssets,
          equals(kmhPositiveAssets),
          reason:
              'All positive KMH balances should be included in positive assets',
        );
        ...
        expect(
          ...
          equals(0.0),
          reason:
              'Positive balance KMH accounts should not contribute to KMH debts',
        );
        ...
        for (var wallet in kmhWallets) {
          ...
          expect(
            ...
            isTrue,
            reason:
                'KMH account with balance ${wallet.balance} should be classified as asset',
          );
          ...
          expect(
            ...
            isFalse,
            reason:
                'KMH account with positive balance should not be classified as debt',
          );
        }
    ...
    PropertyTest.forAll<Map<String, dynamic>>(
      description:
          'Property 24: KMH accounts with negative balance are classified as debts',
      generator: () {
        final kmhAccountCount = PropertyTest.randomInt(min: 1, max: 10);
      ...
      property: (data) async {
        ...
        expect(
          ...
          equals(0.0),
          reason:
              'Negative balance KMH accounts should not contribute to positive assets',
        );
        ...
        for (var wallet in kmhWallets) {
          ...
          expect(
            ...
            isTrue,
            reason:
                'KMH account with balance ${wallet.balance} should be classified as debt',
          );
          ...
          expect(
            ...
            isFalse,
            reason:
                'KMH account with negative balance should not be classified as asset',
          );
        }
    ...
    PropertyTest.forAll<Map<String, dynamic>>(
      description:
          'Property 24: KMH accounts with mixed balances are correctly classified',
      generator: () {
        ...
        for (var wallet in kmhWallets) {
          if (wallet.balance > 0) {
            ...
            expect(
              ...
              isTrue,
              reason:
                  'KMH account ${wallet.name} with positive balance should be in assets',
            );
            ...
            expect(
              ...
              isFalse,
              reason:
                  'KMH account ${wallet.name} with positive balance should not contribute to debts',
            );
            ...
            expect(
              ...
              isTrue,
              reason:
                  'KMH account ${wallet.name} with negative balance should be in debts',
            );
            ...
            expect(
              ...
              isFalse,
              reason:
                  'KMH account ${wallet.name} with negative balance should not contribute to assets',
            );
          }
        }
        ...
        for (var wallet in kmhWallets) {
          ...
          if (wallet.balance != 0) {
            expect(
              ...
              isTrue,
              reason:
                  'Account with non-zero balance must be either asset or debt',
            );
          }
        }
    ...
    PropertyTest.forAll<Map<String, dynamic>>(
      description:
          'Property 24: Zero balance KMH accounts are neither asset nor debt',
      generator: () {
      ...
      property: (data) async {
        ...
        expect(
          ...
          equals(0.0),
          reason:
              'Zero balance KMH accounts should not contribute to positive assets',
        );
        ...
        expect(
          ...
          equals(0.0),
          reason:
              'Zero balance KMH accounts should not contribute to KMH debts',
        );
    ...
    PropertyTest.forAll<Map<String, dynamic>>(
      ...
      property: (data) async {
        ...
        for (var wallet in kmhWallets) {
          final accountData = kmhAccountsData.firstWhere(
            (a) => a['id'] == wallet.id,
          );
          ...
          if (originalBalance > 0) {
            ...
            expect(
              ...
              greaterThan(0),
              reason:
                  'Positive balance should classify as asset regardless of credit limit $creditLimit',
            );
            ...
            expect(
              ...
              lessThan(0),
              reason:
                  'Negative balance should classify as debt regardless of credit limit $creditLimit',
            );
          }
          ...
          if (isAsset) {
            expect(
              ...
              greaterThan(0),
              reason:
                  'Asset classification should be based on positive balance, not credit limit',
            );
          }
          if (isDebt) {
            expect(
              ...
              lessThan(0),
              reason:
                  'Debt classification should be based on negative balance, not credit limit',
            );
          }
        }
