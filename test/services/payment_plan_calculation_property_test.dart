...
void main() {
  group('Payment Plan Calculation Property Tests', () {
    ...
    PropertyTest.forAll<Map<String, double>>(
      description:
          'property: payment plan calculation is mathematically correct',
      generator: () {
        ...
        final multiplier =
            1.1 + PropertyTest.randomPositiveDouble(min: 0.0, max: 3.9);
      ...
      property: (data) {
        ...
        final durationMatch =
            (plan.durationMonths - monthsSimulated).abs() <= monthTolerance;
        final interestMatch =
            (plan.totalInterest - totalInterestPaid).abs() <= tolerance;
        final totalMatch =
            (plan.totalPayment - (debt + totalInterestPaid)).abs() <= tolerance;
    ...
    PropertyTest.forAll<Map<String, double>>(
      description:
          'property: total payment equals initial debt plus total interest',
      generator: () {
        final debt = PropertyTest.randomPositiveDouble(
          min: 1000.0,
          max: 50000.0,
    ...
    PropertyTest.forAll<Map<String, double>>(
      ...
      generator: () {
        ...
        final insufficientPayment =
            monthlyInterest *
            PropertyTest.randomPositiveDouble(min: 0.1, max: 1.0);
    ...
    PropertyTest.forAll<Map<String, double>>(
      ...
      generator: () {
        ...
        final payment1 =
            monthlyInterest *
            (1.5 + PropertyTest.randomPositiveDouble(min: 0.0, max: 1.0));
        final payment2 =
            payment1 *
            (1.2 + PropertyTest.randomPositiveDouble(min: 0.0, max: 0.8));
