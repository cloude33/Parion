...
void main() {
  group('KMH Total Status Property Tests', () {
    ...
    PropertyTest.forAll<Map<String, dynamic>>(
      description:
          'Property 32: Total debt should equal sum of all account debts',
      generator: () {
      ...
      property: (data) async {
        ...
        expect(
          actualTotalDebt,
          closeTo(expectedTotalDebt, 0.01),
    ...
    PropertyTest.forAll<Map<String, dynamic>>(
      description:
          'Property 32: Total interest should equal sum of all account interests',
      generator: () {
        final accountCount = PropertyTest.randomInt(min: 1, max: 10);
      ...
      property: (data) async {
        ...
        expect(
          actualTotalInterest,
          closeTo(expectedTotalInterest, 0.01),
    ...
    PropertyTest.forAll<Map<String, dynamic>>(
      description:
          'Property 32: Total status should be consistent (debt and interest together)',
      generator: () {
      ...
      property: (data) async {
        ...
        for (var accountData in accountsData) {
          ...
          final availableCredit =
              (accountData['creditLimit'] as double) +
              (accountData['balance'] as double);
        ...
        expect(
          actualTotalCreditLimit,
          closeTo(expectedTotalCreditLimit, 0.01),
          reason: 'Total credit limit should match',
        );
        expect(
          actualTotalAvailableCredit,
          closeTo(expectedTotalAvailableCredit, 0.01),
    ...
    PropertyTest.forAll<Map<String, dynamic>>(
      description:
          'Property 32: Total status should handle edge cases (all positive, all negative, mixed)',
      generator: () {
      ...
      property: (data) async {
        ...
        if (scenario == 0) {
          ...
          expect(
            ...
            equals(0.0),
            reason:
                'All positive balances should result in zero total interest',
          );
        } else if (scenario == 1) {
          ...
          expect(
            ...
            greaterThan(0.0),
            reason:
                'All negative balances should result in positive total debt',
          );
          expect(
            totalInterest,
            greaterThan(0.0),
            reason:
                'All negative balances should result in positive total interest',
          );
        }
    ...
    PropertyTest.forAll<Map<String, dynamic>>(
      description:
          'Property 32: Total status should be independent of account order',
      generator: () {
    ...
    PropertyTest.forAll<Map<String, dynamic>>(
      description:
          'Property 32: Total status with single account should equal that account\'s values',
      generator: () {
        final creditLimit = PropertyTest.randomPositiveDouble(
          min: 1000,
          max: 100000,
    ...
    PropertyTest.forAll<Map<String, dynamic>>(
      description:
          'Property 32: Total status with zero accounts should be zero',
      generator: () {
        return {};
      },
      property: (data) async {
