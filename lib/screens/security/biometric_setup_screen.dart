...
class _BiometricSetupScreenState extends State<BiometricSetupScreen> {
  final BiometricAuthService _biometricAuthService = BiometricAuthServiceSingleton.instance;
  ...
  Future<void> _checkBiometricAvailability() async {
    ...
    try {
      ...
      final bool isAvailable = await _biometricAuthService.isAvailable();
      final List<app_biometric.BiometricType> availableBiometrics = 
          await _biometricAuthService.getAvailableTypes();
  ...
  Future<void> _enrollBiometric() async {
    ...
    try {
      // Enable biometric authentication using the auth service
      await _biometricAuthService.enableBiometric();
      
      // Test the biometric authentication to ensure it works
      final AuthResult testResult = await _biometricAuthService.authenticate(
        reason: 'Biyometrik kurulumu doğrulamak için kimliğinizi doğrulayın',
