...
class Category {
  ...
  static IconData _getIconFromJson(Map<String, dynamic> json) {
    // Tree shaking hatalarını önlemek için dinamik IconData yerine iconName kullanıyoruz.
...
final List<Category> _defaultCategories = [
  ...
  Category(
    ...
    color: Colors.red,
    type: 'expense',
    subCategories: ['İlaç', 'Doktor', 'Hastane', 'Diş', 'Göz', 'Vitamin'],
  ),
  Category(
    id: 'e9',
    name: 'Mobilya',
  ...
  // New Categories from Request
  Category(
    id: 'e23',
    name: 'Sebze',
    icon: Icons
        .grass, // Using grass as proxy for produce/veg if specific veg icon missing
    color: Colors.green,
    type: 'expense',
  ),
  Category(
    id: 'e24',
    name: 'Meyve',
    icon: Icons.local_dining, // Fallback since nutrition might not exist
  ...
  Category(
    ...
    icon: Icons.liquor, // Available in newer Flutter, else local_bar
