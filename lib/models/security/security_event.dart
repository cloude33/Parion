...
class SecurityEvent {
  ...
  factory SecurityEvent.authenticationAttempt({
    ...
    return SecurityEvent(
      type: SecurityEventType.pinVerified, // Using existing type as placeholder
      userId: userId,
      description: 'Authentication attempt with ${method.displayName}',
      severity: SecurityEventSeverity.info,
      source: 'AuthOrchestrator',
      timestamp: timestamp,
      metadata: {
        'method': method.name,
        ...?metadata,
  ...
  factory SecurityEvent.authenticationSuccess({
    required AuthMethod method,
    required DateTime timestamp,
    String? userId,
    String? sessionId,
    ...
    return SecurityEvent(
      type: SecurityEventType.sessionStarted,
      userId: userId,
      description: 'Authentication successful with ${method.displayName}',
      severity: SecurityEventSeverity.info,
      source: 'AuthOrchestrator',
      timestamp: timestamp,
      metadata: {
  ...
  factory SecurityEvent.authenticationFailure({
    required AuthMethod method,
    required DateTime timestamp,
    String? userId,
    required String reason,
    ...
    return SecurityEvent(
      type: SecurityEventType.pinFailed, // Using existing type as placeholder
      userId: userId,
      description: 'Authentication failed with ${method.displayName}: $reason',
      severity: SecurityEventSeverity.warning,
      source: 'AuthOrchestrator',
      timestamp: timestamp,
      metadata: {
  ...
  factory SecurityEvent.authenticationError({
    required AuthMethod method,
    required DateTime timestamp,
    String? userId,
    ...
    return SecurityEvent(
      type: SecurityEventType.suspiciousActivity,
      userId: userId,
      description: 'Authentication error with ${method.displayName}: $error',
      severity: SecurityEventSeverity.error,
      source: 'AuthOrchestrator',
      timestamp: timestamp,
      metadata: {
  ...
  /// Sensitive operation authentication event
  factory SecurityEvent.sensitiveOperationAuth({
    required AuthMethod method,
    required DateTime timestamp,
    String? userId,
    String? sessionId,
    ...
    return SecurityEvent(
      type: SecurityEventType.biometricVerified, // Using existing type as placeholder
      userId: userId,
      description: 'Sensitive operation authenticated with ${method.displayName}',
      severity: SecurityEventSeverity.info,
      source: 'AuthOrchestrator',
      timestamp: timestamp,
      metadata: {
  ...
  factory SecurityEvent.appBackground({
    required DateTime timestamp,
    String? userId,
    String? sessionId,
    Map<String, dynamic>? metadata,
    ...
    return SecurityEvent(
      type: SecurityEventType.sessionEnded, // Using existing type as placeholder
      userId: userId,
  ...
  factory SecurityEvent.appForeground({
    required DateTime timestamp,
    String? userId,
    String? sessionId,
    Map<String, dynamic>? metadata,
    ...
    return SecurityEvent(
      type: SecurityEventType.sessionStarted, // Using existing type as placeholder
      userId: userId,
  ...
  factory SecurityEvent.passwordResetRequested({
  ...
  factory SecurityEvent.passwordResetFailed({
    required String email,
    required DateTime timestamp,
    String? userId,
    required String error,
    ...
    return SecurityEvent(
      type: SecurityEventType.suspiciousActivity,
      userId: userId,
      description: 'Password reset failed for email: $email - $error',
      severity: SecurityEventSeverity.warning,
      source: 'AuthOrchestrator',
      timestamp: timestamp,
      metadata: {
